# Generated by Django 4.2.1 on 2023-10-03 15:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('startDate', models.DateField(default=datetime.datetime(2023, 10, 3, 15, 33, 40, 797694, tzinfo=datetime.timezone.utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('startDate', models.DateField(default=datetime.datetime(2023, 10, 3, 15, 33, 40, 795704, tzinfo=datetime.timezone.utc))),
                ('endDate', models.DateField(blank=True, null=True)),
                ('clientId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Basic_app.client')),
